  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.inventoryCategory.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="storeApp.inventoryCategory.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="category-name">
                  <Translate contentKey="storeApp.inventoryCategory.name">Name</Translate>
                </Label>
                <AvField
                  id="category-name"
                  data-cy="name"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="category-description">
                  <Translate contentKey="storeApp.inventoryCategory.description">Description</Translate>
                </Label>
