...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.inventoryProductCategory.delete.question">
        <Translate contentKey="storeApp.inventoryProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
