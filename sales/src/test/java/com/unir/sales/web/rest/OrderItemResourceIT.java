...
import static com.unir.sales.web.rest.TestUtil.sameNumber;
...
class OrderItemResourceIT {
    ...
    private static final Integer DEFAULT_PRICE_PER_ITEM = 0;
    private static final Integer UPDATED_PRICE_PER_ITEM = 1;
    ...
    public static OrderItem createUpdatedEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem()
            ...
            .pricePerItem(UPDATED_PRICE_PER_ITEM)
    ...
    void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getPricePerItem()).isEqualTo(DEFAULT_PRICE_PER_ITEM);
    ...
    @Test
    @Transactional
    void checkPricePerItemIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderItemRepository.findAll().size();
        // set the field null
        orderItem.setPricePerItem(null);
    ...
    void getAllOrderItems() throws Exception {
        ...
        restOrderItemMockMvc
            ...
            .andExpect(jsonPath("$.[*].pricePerItem").value(hasItem(DEFAULT_PRICE_PER_ITEM)))
    ...
    void getOrderItem() throws Exception {
        ...
        restOrderItemMockMvc
            ...
            .andExpect(jsonPath("$.pricePerItem").value(DEFAULT_PRICE_PER_ITEM))
    ...
    void putNewOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getPricePerItem()).isEqualTo(UPDATED_PRICE_PER_ITEM);
