...
export const CategoryDeleteDialog = (props: ICategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.inventoryCategory.delete.question">
        <Translate contentKey="storeApp.inventoryCategory.delete.question" interpolate={{ id: categoryEntity.id }}>
