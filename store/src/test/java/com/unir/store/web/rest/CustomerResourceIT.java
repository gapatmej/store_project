...
class CustomerResourceIT {
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.lastName(UPDATED_LAST_NAME).gender(UPDATED_GENDER).email(UPDATED_EMAIL).addressLine1(UPDATED_ADDRESS_LINE_1);
