package com.unir.store.config;

import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import com.unir.store.security.AuthoritiesConstants;
import com.unir.store.security.jwt.JWTFilter;
import com.unir.store.security.jwt.TokenProvider;
import com.unir.store.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/services/inventory/api/public/**").permitAll()
            .pathMatchers("/services/sales/api/public/**").permitAll()
