...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_ORDERITEM),
          REQUEST(ACTION_TYPES.UPDATE_ORDERITEM),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ORDERITEM),
          REQUEST(ACTION_TYPES.DELETE_ORDERITEM),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_ORDERITEM),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_ORDERITEM actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ORDERITEM),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_ORDERITEM),
          payload: resolvedObject,
        },
      ];
